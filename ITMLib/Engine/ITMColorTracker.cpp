...
ITMColorTracker::EvaluationPoint::EvaluationPoint(ITMPose *para, const ITMColorTracker *f_parent)
{
	float localF[1];

    this->mPara = para; this->mParent = f_parent;
...
static inline bool minimizeLM(const ITMColorTracker & tracker, ITMPose & initialization)
{
	...
	do
	{
		...
		bool success;
		{
            ...
            /// Solve A.d = grad
            ORUtils::Cholesky::solve(A, numPara, grad, d);
